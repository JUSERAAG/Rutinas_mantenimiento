...
Public Class FormMecanicoNT
    ...
    Private Sub FormElectricoNT_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ComboBox100.Items.Add("Sistema o equipos")
        ComboBox100.Items.Add("Equipos varios o periféricos")
        TextBox53.Text = fechaActual.ToString("yyyy-MM-dd")
        ...
        Using conexion As New SqlConnection(conn)
            Try
                ...
                Using comando As New SqlCommand(consulta, conexion)
                    ...
                    comando.Parameters.AddWithValue("@VAR52", If(CheckBox42.Checked, 1, 0))
                    comando.Parameters.AddWithValue("@VAR53", If(CheckBox43.Checked, 1, 0))
                    comando.Parameters.AddWithValue("@VAR54", If(CheckBox44.Checked, 1, 0))
                    comando.Parameters.AddWithValue("@VAR55", If(CheckBox45.Checked, 1, 0))
                    comando.Parameters.AddWithValue("@VAR56", If(CheckBox46.Checked, 1, 0))
                    comando.Parameters.AddWithValue("@VAR57", If(CheckBox47.Checked, 1, 0))
                    comando.Parameters.AddWithValue("@VAR58", If(CheckBox48.Checked, 1, 0))
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox100.SelectedIndexChanged
        Select Case ComboBox100.SelectedItem()
            Case "Sistema o equipos"
                ...
                Panel2.Visible = True
                Panel2.Enabled = True
            Case "Equipos varios o periféricos"
