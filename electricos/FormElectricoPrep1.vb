...
Public Class FormElectricoPrep1
    ...
    Private Sub FormElectricoNT_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        TextBox49.Text = fechaActual.ToString("yyyy-MM-dd")
        TextBox50.Text = horaActual.ToString("hh\:mm\:ss")
    End Sub
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Using conexion As New SqlConnection(conn)
            Try
                conexion.Open()
                Dim consulta As String = "INSERT INTO dbo.Electrico_Prep1 VALUES (@FECHA,@HORA,@VAR1,@VAR2,@VAR3,@VAR4,@VAR5,@VAR6,@VAR7,@VAR8,@VAR9,@VAR10,@VAR11,@VAR12,@VAR13,@VAR15,@VAR16,@VAR17,@VAR18,@VAR19,@VAR20,@VAR21,@VAR22,@VAR23,@VAR24,@VAR25,@VAR26,@VAR27,@VAR28,@VAR29,@VAR30,@VAR30,@VAR31,@VAR32,@VAR33,@VAR34,@VAR35,@VAR36,@VAR37,@VAR38,@VAR39,@VAR40,@VAR41,@VAR42,@VAR43,@VAR44,@VAR45,@VAR46, @VAR47, @VAR48)"
                Using comando As New SqlCommand(consulta, conexion)
                    ...
                    comando.Parameters.AddWithValue("@VAR48", TextBox48.Text)
